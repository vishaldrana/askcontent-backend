...
TABLES = [
    "askcontent_org",
    "askcontent_workspace",
    "askcontent_knowledgebase",
    "askcontent_connector",
    "askcontent_field_rule",
    "askcontent_authority_rule",
    "askcontent_rbac_role",
    "askcontent_rbac_role_member",
    "askcontent_rbac_label_rule",
    "askcontent_collection",
    "askcontent_collection_rule",
    "askcontent_collection_member",
    "askcontent_document",
    ...
    "askcontent_embed",
    "askcontent_upload",
    "askcontent_url_paste",
    "askcontent_document_pin",
]
...
SKIPPED = {
    "askcontent_embedding": "derived from document_chunk; ~59 MB of floats. Run: askcontent reembed",
    "askcontent_job": "operational history of one database on one afternoon",
    "askcontent_retrieval_run": "operational history",
    "askcontent_retrieval_plan": "operational history",
    "askcontent_eval_run": "operational history",
    "askcontent_eval_result": "operational history",
    "askcontent_answer_feedback": "operational history",
    "askcontent_scope_change": "operational history",
    "askcontent_auth_session": "credentials",
    "askcontent_embed_session": "operational history",
    "askcontent_app_user": "identities, which belong to a deployment and not to a fixture",
    "askcontent_membership": "identities",
    "askcontent_chat_thread": "somebody's questions; not seed data",
    "askcontent_chat_turn": "somebody's questions; not seed data",
    "askcontent_thread": "superseded by chat_thread",
    "askcontent_message": "superseded by chat_turn",
    "askcontent_quarantine_item": "operational history",
    "askcontent_rbac_policy_version": "operational history",
